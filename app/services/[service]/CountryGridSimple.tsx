...
interface CountryGridSimpleProps {
  countries: {
    name: string;
    slug: string;
    flag: string;
...
export default function CountryGridSimple({
  countries,
  serviceSlug,
  serviceTitle,
}: CountryGridSimpleProps) {
  return (
    <section className="py-20 md:py-28">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-heading)] text-text-primary mb-4 text-center">
          {serviceTitle} Services Worldwide
        </h2>
        <p className="text-text-muted text-center mb-12 max-w-2xl mx-auto">
          We deliver {serviceTitle} results for businesses in{" "}
          {countries.length} countries across the globe.
        </p>
